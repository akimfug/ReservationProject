...
async function main() {
  ...
  // Создаем несколько броней на сегодня
  ...
  const reservations = [
    {
      ...
      partySize: 4,
      startAt: new Date(today.getTime() + 12 * 60 * 60 * 1000), // 12:00
    ...
    },
    {
      ...
      partySize: 2,
      startAt: new Date(today.getTime() + 19 * 60 * 60 * 1000), // 19:00
    ...
    },
    {
      ...
      partySize: 6,
      startAt: new Date(today.getTime() + 20 * 60 * 60 * 1000), // 20:00
      status: ReservationStatus.CONFIRMED,
    },
    {
    ...
    await prisma.reservation.create({
      data: {
        ...
        expectedEnd: new Date(
          reservation.startAt.getTime() + 2 * 60 * 60 * 1000,
        ), // +2 часа
      },
    });
  }

  // Обновляем статусы столов в соответствии с бронированиями
  ...
  await prisma.table.update({
    ...
    data: { status: TableStatus.OUT_OF_SERVICE },
  });
